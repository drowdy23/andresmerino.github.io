...
const css = `
        ...
        .side-btn:hover .side-line { height: 100px; background: #fff; }
`;
...
files.forEach(file => {
    ...
    // Clean up any remnants of prior attempts
    ...
    content = content.replace(/const sideContact[\s\S]*?\}\);/, '');
...
console.log('Vertical side contact applied to all remaining pages.');